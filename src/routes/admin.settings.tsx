...
function AdminSettings() {
  ...
  async function saveStore() {
    ...
    try {
      ...
      console.error(
        "[AdminSettings] store save failed:",
        error,
      );
  ...
  async function saveInvoice() {
    ...
    try {
      ...
      console.error(
        "[AdminSettings] invoice save failed:",
        error,
      );
  ...
  const setInvoiceValue = <
    K extends keyof InvoiceSettings
  >(
    key: K,
        ...
        <div className="mb-5 flex items-start gap-3 rounded-2xl border border-[#0D3B4D]/10 bg-[#F6F2EE]/60 p-4">
          ...
          <div>
            ...
            <p className="mt-1 text-xs leading-6 text-muted-foreground">
              تحكم كامل في شكل ومحتوى الفاتورة
              التي تظهر للعميل والإدارة والطباعة.
            </p>
          </div>
        </div>
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                <Field label="السجل التجاري">
                  <input
                    className={inputCls}
                    value={
                      invoice.commercial_registration
                    }
                    maxLength={100}
                    onChange={(e) =>
                      setInvoiceValue(
