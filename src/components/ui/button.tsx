...
export function Button({
  ...
  const base = "inline-flex items-center justify-center gap-2 font-semibold rounded-[var(--radius)] transition-all";
  ...
  const variants: Record<string, string> = {
    ...
    secondary: `bg-[var(--color-surface)] text-[var(--color-foreground)] border border-[var(--border)] hover:bg-[color-mix(in srgb,var(--color-surface) 92%,var(--color-primary) 8%)]`,
