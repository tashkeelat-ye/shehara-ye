  ...
  return (
    <section
      ...
      className="
        ...
        backdrop-blur-sm
        dark:border-white/[0.07] dark:bg-[#0A2A38]/95
        sm:p-3
      "
    >
      <div
        ...
        className="
          ...
          h-44 w-44 rounded-full bg-[#0E4D64]/[0.05]
          blur-3xl dark:bg-[#D65A31]/[0.035]
        "
      />
            ...
            >
              <span
                ...
                className={`
                  ...
                  ${item.orange ? "bg-[#D65A31]/[0.12]" : "bg-[#0E4D64]/[0.10]"}
                `}
              />
