    ...
    <>
      <header
        className="
          ...
          backdrop-blur-xl
          supports-[backdrop-filter]:bg-[color:var(--background)]/85
        "
      >
              ...
              >
                <div
                  className="
                    ...
                    transition-all
                    duration-200
                    focus-within:border-[#0E4D64]/20
                    focus-within:ring-4
                    focus-within:ring-[#0E4D64]/5
                  "
                >
                  <Search
                    size={19}
      ...
      {/* مساحة تعويضية أسفل الهيدر الثابت */}
      <div
        aria-hidden="true"
        className={
          isHome
            ? "h-[calc(136px+env(safe-area-inset-top))]"
            : "h-[calc(68px+env(safe-area-inset-top))]"
        }
      />
    </>
  );
